...
@section('content')
	<div class="row">
		<div class="col-xs-12 col-xs-offset-0 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
			{!! Form::model($zone, ["class" => "form-horizontal"]) !!}
			
			<div class="form-group">
				{!! Form::label("name", __("Zone"), ["class" => "col-sm-3 text-right control-label"]) !!}
				<div class="col-sm-9">
			...
			<div class="form-group">
				<div class="col-xs-12 col-xs-offset-0 col-sm-9 col-sm-offset-3">
					<div class="row">
						...
						<div class="col-xs-6">
							<a href="{{ url('cities/'.$city->id.'/zones') }}" class="btn btn-danger btn-block">{{ __("Cancel") }}</a>
						</div>
					</div>
				</div>
			</div>
